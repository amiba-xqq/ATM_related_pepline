//第2行和第34行是唯一需要改的地方，本代码其它地方不可改动
input_path = "C:\\Users\\13103\\Desktop\\confocol\\niechen_20231217\\PLA NBS1 BrU\\";
// 创建新的文件夹
...
for (image=0; image < n_images; image++) {
  ...
  //下面中c1是red通道，c2是green通道，c3是blue通道
  //merged_image0指C=0结尾的图片，merged_image1指C=1结尾的图片，merged_image2指C=2结尾的图片
  //更改merged_image0/1/2的位置，使得它们和c1/c2/c3的通道颜色相同
