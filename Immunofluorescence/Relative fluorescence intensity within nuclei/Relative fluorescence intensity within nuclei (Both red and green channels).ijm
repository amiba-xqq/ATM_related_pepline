// 设置参数，只需要更改3-9行代码的参数; 第3行是Batch export TIFF images from LIF files脚本得到的TIFF文件所在的文件夹
// Set parameters; only modify the parameters in lines 3–9 of the code;  Line 3 specifies the folder containing the TIFF files exported from 'Batch export TIFF images from LIF files' script
...
for (i=0; i<list.length; i++) {
    ...
    red_path = folder_path + "_red_level.csv";
   ...
   setAutoThreshold("Default dark");
   run("Threshold...");
   setThreshold(Threshold_red, 255, "raw");
