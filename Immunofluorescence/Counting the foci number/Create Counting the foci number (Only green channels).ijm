...
for (i=0; i<list.length; i++) {
    ...
    selectWindow(folder_green);
    run("Speckle Inspector", "primary=[" + folder_blue + "] secondary=[" + folder_green + "] redirect=[" + folder_green + "] min_primary_size=" + min_size + " max_primary_size=" + max_size + " min_secondary_size=" + min_speckle + " max_secondary_size=" + max_speckle + " show=primary exclude speckle");
