...
#ctrl means control group;Eto means only Etoposide treatment;EtoA means combination of Etoposide and ATM inhibitor;EtoI means combination of Etoposide and IRAK1 inhibitor.
